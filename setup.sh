...
mkdir server0
	cd server0
		wget paperclip.jar https://papermc.io/api/v1/paper/$Version/latest/download
		wget start.sh https://raw.githubusercontent.com/Simylein/Minecraft_Server/master/start.sh
...
mkdir backups
	cd backups
		wget backup.sh https://raw.githubusercontent.com/Simylein/Minecraft_Server/master/backup.sh
	cd
