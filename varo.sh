...
while true; do
screen ${servername} -X hardcopy "tmp-log"
tail -n1 tmp-log >> tmp-log-last-line
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player1" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player1}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player1} You died! Thank you for participating in Varo$(printf '\r')"
                        echo -e "${red}${player1} died!"
                        break
                fi
        fi
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player2" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player2}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player2} You died! Thank you for participating in Varo$(printf '\r')"
                        echo -e "${red}${player2} died!"
                        break
                fi
        fi
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player3" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player3}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player3} You died! Thank you for participating in Varo$(printf '\r')"
                        echo -e "${red}${player3} died!"
                        break
                fi
        fi
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player4" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player4}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player4} You died! Thank you for participating in Varo$(printf '\r')"
                        echo -e "${red}${player4} died!"
                        break
                fi
        fi
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player5" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player5}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player5} You died! Thank you for participating in Varo$(printf '\r')"
                        echo -e "${red}${player5} died!"
                        break
                fi
        fi
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player6" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player6}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player6} You died! Thank you for participating in Varo$(printf '\r')"
                        echo -e "${red}${player6} died!"
                        break
                fi
        fi
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player7" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player7}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player7} You died! Thank you for participating in Varo$(printf '\r')"
                        echo -e "${red}${player7} died!"
                        break
                fi
        fi
        if [[ ! -z $(grep -E "$death01|$death02|$death03|$death04|$death05|$death06|$death07|$death08|$death09|$death10|$death11|$death12|$death13|$death14|$death15|$death16|$death17|$death18|$death19|$death20|$death21|$death22|$death23|$death24|$death25|$death26|$death27|$death28|$death29|$death30|$death31|$death32|$death33|$death34|$death35|$death36|$death37" "$tmp-log-last-line") ]]; then
                if [[ ! -z $(grep "$player8" "$tmp-log-last-line") ]]; then
                        screen -Rd ${servername} -X stuff "gamemode 3 ${player8}$(printf '\r')"
                        screen -Rd ${servername} -X stuff "kick ${player8} You died! Thank you for participating in Varo$(printf '\r')"
